...
import power.keepeersofthestones.procedures.IceBallInBlockProcedure;
...
public class IceBallEntity extends AbstractArrow implements ItemSupplier {
	public IceBallEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(PowerModEntities.ICE_BALL.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(PowerModItems.ICE_BALL.get());
	}
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		IceBallInBlockProcedure.execute(this.level, blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(),
	...
	public static IceBallEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		IceBallEntity entityarrow = new IceBallEntity(PowerModEntities.ICE_BALL.get(), entity, world);
	...
	public static IceBallEntity shoot(LivingEntity entity, LivingEntity target) {
		IceBallEntity entityarrow = new IceBallEntity(PowerModEntities.ICE_BALL.get(), entity, entity.level);
