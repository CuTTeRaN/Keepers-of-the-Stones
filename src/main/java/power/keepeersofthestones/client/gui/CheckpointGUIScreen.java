...
public class CheckpointGUIScreen extends AbstractContainerScreen<CheckpointGUIMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.power.checkpoint_gui.label_returning_to_the_last_point"), 15, 7, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.power.checkpoint_gui.label_time_travel"), 60, 79, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(
				new Button(this.leftPos + 24, this.topPos + 25, 126, 20, Component.translatable("gui.power.checkpoint_gui.button_checkpoint"), e -> {
					if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 24, this.topPos + 52, 126, 20,
				Component.translatable("gui.power.checkpoint_gui.button_set_checkpoint"), e -> {
					if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 24, this.topPos + 97, 126, 20,
				Component.translatable("gui.power.checkpoint_gui.button_return_to_the_past"), e -> {
					if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 24, this.topPos + 124, 134, 20,
				Component.translatable("gui.power.checkpoint_gui.button_return_to_the_present"), e -> {
					if (true) {
