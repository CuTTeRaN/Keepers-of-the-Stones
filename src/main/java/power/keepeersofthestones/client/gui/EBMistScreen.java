...
import power.keepeersofthestones.network.EBMistButtonMessage;
...
public class EBMistScreen extends AbstractContainerScreen<EBMistMenu> {
	private final static HashMap<String, Object> guistate = EBMistMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public EBMistScreen(EBMistMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/screens/mist_stone.png"));
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/screens/mist_element.png"));
