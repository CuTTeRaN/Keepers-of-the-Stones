...
import power.keepeersofthestones.network.EBWaterButtonMessage;
...
public class EBWaterScreen extends AbstractContainerScreen<EBWaterMenu> {
	private final static HashMap<String, Object> guistate = EBWaterMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public EBWaterScreen(EBWaterMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/screens/water_stone.png"));
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/screens/water_element.png"));
