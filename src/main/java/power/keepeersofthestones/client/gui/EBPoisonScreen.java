...
import power.keepeersofthestones.network.EBPoisonButtonMessage;
...
public class EBPoisonScreen extends AbstractContainerScreen<EBPoisonMenu> {
	private final static HashMap<String, Object> guistate = EBPoisonMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public EBPoisonScreen(EBPoisonMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/screens/poison_stone.png"));
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/screens/poison_element.png"));
