...
public class EBOceanScreen extends AbstractContainerScreen<EBOceanMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/screens/ocean_stone.png"));
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/screens/ocean_element.png"));
		this.blit(ms, this.leftPos + 71, this.topPos + -85, 0, 0, 62, 127, 62, 127);
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.power.eb_ocean.label_class_additional"), -162, -85, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.power.eb_ocean.label_element_ocean"), -162, -67, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.power.eb_ocean.label_force_deepness"), -162, -49, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(
				new Button(this.leftPos + 152, this.topPos + 86, 30, 20, Component.translatable("gui.power.eb_ocean.button_empty"), e -> {
					if (true) {
