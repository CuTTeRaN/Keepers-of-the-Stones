...
public class EBMushroomsScreen extends AbstractContainerScreen<EBMushroomsMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.power.eb_mushrooms.label_class_middle"), -162, -85, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.power.eb_mushrooms.label_element_mushrooms"), -162, -67, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.power.eb_mushrooms.label_force_distribution"), -162, -49, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(
				new Button(this.leftPos + 152, this.topPos + 86, 30, 20, Component.translatable("gui.power.eb_mushrooms.button_empty"), e -> {
					if (true) {
