...
public class EBSpeedScreen extends AbstractContainerScreen<EBSpeedMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.power.eb_speed.label_class_additional"), -162, -85, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.power.eb_speed.label_element_speed"), -162, -67, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.power.eb_speed.label_force_boost"), -162, -49, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(
				new Button(this.leftPos + 152, this.topPos + 86, 30, 20, Component.translatable("gui.power.eb_speed.button_empty"), e -> {
					if (true) {
