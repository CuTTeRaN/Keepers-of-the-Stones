...
import power.keepeersofthestones.network.EBAnimalsButtonMessage;
...
public class EBAnimalsScreen extends AbstractContainerScreen<EBAnimalsMenu> {
	private final static HashMap<String, Object> guistate = EBAnimalsMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public EBAnimalsScreen(EBAnimalsMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/screens/animals_stone.png"));
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/screens/animals_element.png"));
