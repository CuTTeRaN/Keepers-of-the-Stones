...
import power.keepeersofthestones.network.EBMercuryButtonMessage;
...
public class EBMercuryScreen extends AbstractContainerScreen<EBMercuryMenu> {
	private final static HashMap<String, Object> guistate = EBMercuryMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public EBMercuryScreen(EBMercuryMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/screens/mercury_stone.png"));
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/screens/mercury_element.png"));
