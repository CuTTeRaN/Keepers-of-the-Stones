...
import power.keepeersofthestones.network.EBLightButtonMessage;
...
public class EBLightScreen extends AbstractContainerScreen<EBLightMenu> {
	private final static HashMap<String, Object> guistate = EBLightMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public EBLightScreen(EBLightMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/screens/light_stone.png"));
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/screens/light_element.png"));
