...
import power.keepeersofthestones.network.ChoiseSecretStoneGUIButtonMessage;
...
public class ChoiseSecretStoneGUIScreen extends AbstractContainerScreen<ChoiseSecretStoneGUIMenu> {
	private final static HashMap<String, Object> guistate = ChoiseSecretStoneGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ChoiseSecretStoneGUIScreen(ChoiseSecretStoneGUIMenu container, Inventory inventory, Component text) {
