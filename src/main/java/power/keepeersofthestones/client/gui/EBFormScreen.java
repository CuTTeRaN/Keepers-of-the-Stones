...
import power.keepeersofthestones.network.EBFormButtonMessage;
...
public class EBFormScreen extends AbstractContainerScreen<EBFormMenu> {
	private final static HashMap<String, Object> guistate = EBFormMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public EBFormScreen(EBFormMenu container, Inventory inventory, Component text) {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, "Element: Form", -162, -67, -12829636);
		this.font.draw(poseStack, "Force: Disguise", -162, -49, -12829636);
	}
