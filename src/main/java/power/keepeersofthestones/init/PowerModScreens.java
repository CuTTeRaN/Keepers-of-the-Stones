...
public class PowerModScreens {
	...
	public static void clientLoad(FMLClientSetupEvent event) {
		event.enqueueWork(() -> {
			...
			MenuScreens.register(PowerModMenus.EB_MIND, EBMindScreen::new);
			MenuScreens.register(PowerModMenus.EB_GOLDEN_DUST, EBGoldenDustScreen::new);
			MenuScreens.register(PowerModMenus.CHOISE_SECRET_STONE_GUI, ChoiseSecretStoneGUIScreen::new);
		});
	}
}
