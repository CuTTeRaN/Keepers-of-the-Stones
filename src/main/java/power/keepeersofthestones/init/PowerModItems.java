...
import power.keepeersofthestones.item.AquaticaItem;
...
public class PowerModItems {
	...
	public static final RegistryObject<Item> TYRANNOSAURUS_REX = REGISTRY.register("tyrannosaurus_rex_spawn_egg",
			() -> new ForgeSpawnEggItem(PowerModEntities.TYRANNOSAURUS_REX, -52480, -39322, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> RAPTOR = REGISTRY.register("raptor_spawn_egg",
			() -> new ForgeSpawnEggItem(PowerModEntities.RAPTOR, -16738048, -6684775, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> PLESIOSAURUS = REGISTRY.register("plesiosaurus_spawn_egg",
			() -> new ForgeSpawnEggItem(PowerModEntities.PLESIOSAURUS, -10092442, -3407668, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> PTERODACTYL = REGISTRY.register("pterodactyl_spawn_egg",
			() -> new ForgeSpawnEggItem(PowerModEntities.PTERODACTYL, -3355648, -103, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	...
	public static final RegistryObject<Item> SPIRIT_BATTERY = REGISTRY.register("spirit_battery", () -> new SpiritBatteryItem());
	...
	public static final RegistryObject<Item> SPACE_HELMET = REGISTRY.register("space_helmet", () -> new SpaceItem.Helmet());
	public static final RegistryObject<Item> SPACE_CHESTPLATE = REGISTRY.register("space_chestplate", () -> new SpaceItem.Chestplate());
	public static final RegistryObject<Item> SPACE_LEGGINGS = REGISTRY.register("space_leggings", () -> new SpaceItem.Leggings());
	public static final RegistryObject<Item> SPACE_BOOTS = REGISTRY.register("space_boots", () -> new SpaceItem.Boots());
	...
	public static final RegistryObject<Item> PLAGUE_HELMET = REGISTRY.register("plague_helmet", () -> new PlagueItem.Helmet());
	public static final RegistryObject<Item> PLAGUE_CHESTPLATE = REGISTRY.register("plague_chestplate", () -> new PlagueItem.Chestplate());
	public static final RegistryObject<Item> PLAGUE_LEGGINGS = REGISTRY.register("plague_leggings", () -> new PlagueItem.Leggings());
	public static final RegistryObject<Item> PLAGUE_BOOTS = REGISTRY.register("plague_boots", () -> new PlagueItem.Boots());
	...
	public static final RegistryObject<Item> SPIRIT_HELMET = REGISTRY.register("spirit_helmet", () -> new SpiritItem.Helmet());
	public static final RegistryObject<Item> SPIRIT_CHESTPLATE = REGISTRY.register("spirit_chestplate", () -> new SpiritItem.Chestplate());
	public static final RegistryObject<Item> SPIRIT_LEGGINGS = REGISTRY.register("spirit_leggings", () -> new SpiritItem.Leggings());
	public static final RegistryObject<Item> SPIRIT_BOOTS = REGISTRY.register("spirit_boots", () -> new SpiritItem.Boots());
	public static final RegistryObject<Item> SCYTHE = REGISTRY.register("scythe", () -> new ScytheItem());
	public static final RegistryObject<Item> ECTOPLASM_ATTACK = REGISTRY.register("ectoplasm_attack", () -> new EctoplasmAttackItem());
	public static final RegistryObject<Item> GHOST_FORM = REGISTRY.register("ghost_form", () -> new GhostFormItem());
	public static final RegistryObject<Item> AETHER_HELMET = REGISTRY.register("aether_helmet", () -> new AetherItem.Helmet());
	public static final RegistryObject<Item> AETHER_CHESTPLATE = REGISTRY.register("aether_chestplate", () -> new AetherItem.Chestplate());
	public static final RegistryObject<Item> AETHER_LEGGINGS = REGISTRY.register("aether_leggings", () -> new AetherItem.Leggings());
	public static final RegistryObject<Item> AETHER_BOOTS = REGISTRY.register("aether_boots", () -> new AetherItem.Boots());
	public static final RegistryObject<Item> ETHEREAL_STAFF = REGISTRY.register("ethereal_staff", () -> new EtherealStaffItem());
	public static final RegistryObject<Item> PEGASUS_WINGS = REGISTRY.register("pegasus_wings", () -> new PegasusWingsItem());
	public static final RegistryObject<Item> NEPTUNE_SWORD = REGISTRY.register("neptune_sword", () -> new NeptuneSwordItem());
	public static final RegistryObject<Item> FIREBIRD_FEATHER = REGISTRY.register("firebird_feather", () -> new FirebirdFeatherItem());
	public static final RegistryObject<Item> GNOME_PICKAXE = REGISTRY.register("gnome_pickaxe", () -> new GnomePickaxeItem());
	public static final RegistryObject<Item> SMOKE_HELMET = REGISTRY.register("smoke_helmet", () -> new SmokeItem.Helmet());
	public static final RegistryObject<Item> SMOKE_CHESTPLATE = REGISTRY.register("smoke_chestplate", () -> new SmokeItem.Chestplate());
	public static final RegistryObject<Item> SMOKE_LEGGINGS = REGISTRY.register("smoke_leggings", () -> new SmokeItem.Leggings());
	public static final RegistryObject<Item> SMOKE_BOOTS = REGISTRY.register("smoke_boots", () -> new SmokeItem.Boots());
	public static final RegistryObject<Item> NUNCHUCKS = REGISTRY.register("nunchucks", () -> new NunchucksItem());
	public static final RegistryObject<Item> SMOKE_SCREEN = REGISTRY.register("smoke_screen", () -> new SmokeScreenItem());
	public static final RegistryObject<Item> DISPERSION = REGISTRY.register("dispersion", () -> new DispersionItem());
	public static final RegistryObject<Item> FORM_BATTERY = REGISTRY.register("form_battery", () -> new FormBatteryItem());
	public static final RegistryObject<Item> FORM_HELMET = REGISTRY.register("form_helmet", () -> new FormItem.Helmet());
	public static final RegistryObject<Item> FORM_CHESTPLATE = REGISTRY.register("form_chestplate", () -> new FormItem.Chestplate());
	public static final RegistryObject<Item> FORM_LEGGINGS = REGISTRY.register("form_leggings", () -> new FormItem.Leggings());
	public static final RegistryObject<Item> FORM_BOOTS = REGISTRY.register("form_boots", () -> new FormItem.Boots());
	...
	public static final RegistryObject<Item> AQUATICA = REGISTRY.register("aquatica", () -> new AquaticaItem());
