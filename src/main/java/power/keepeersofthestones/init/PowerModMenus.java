...
public class PowerModMenus {
	...
	public static final MenuType<ChoiseSecretStoneGUIMenu> CHOISE_SECRET_STONE_GUI = register("choise_secret_stone_gui",
			(id, inv, extraData) -> new ChoiseSecretStoneGUIMenu(id, inv, extraData));
