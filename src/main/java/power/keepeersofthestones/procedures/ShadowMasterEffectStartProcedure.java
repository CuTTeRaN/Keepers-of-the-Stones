...
public class ShadowMasterEffectStartProcedure {
			...
			if (!_ent.level.isClientSide() && _ent.getServer() != null)
				_ent.getServer().getCommands().performCommand(
						new CommandDispatcher<CommandSourceStack>().parse(
								"give @s power:shadow_sword{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}",
								_ent.createCommandSourceStack().withSuppressedOutput().withPermission(4)),
						"give @s power:shadow_sword{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
		}
		{
			...
			if (!_ent.level.isClientSide() && _ent.getServer() != null)
				_ent.getServer().getCommands().performCommand(
						new CommandDispatcher<CommandSourceStack>().parse(
								"give @s power:shadow_ball{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}",
								_ent.createCommandSourceStack().withSuppressedOutput().withPermission(4)),
						"give @s power:shadow_ball{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
		}
		{
