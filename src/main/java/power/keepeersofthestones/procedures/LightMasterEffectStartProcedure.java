...
public class LightMasterEffectStartProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
					...
					.orElse(new PowerModVariables.PlayerVariables())).golden_dust) {
				{
					...
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						...
						_ent.getServer().getCommands().performPrefixedCommand(_css,
								"item replace entity @s armor.head with power:light_helmet{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
					}
				}
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						...
						_ent.getServer().getCommands().performPrefixedCommand(_css,
								"item replace entity @s armor.chest with power:light_chestplate{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
					}
				}
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						...
						_ent.getServer().getCommands().performPrefixedCommand(_css,
								"item replace entity @s armor.legs with power:light_leggings{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
					}
				}
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						...
						_ent.getServer().getCommands().performPrefixedCommand(_css,
								"item replace entity @s armor.feet with power:light_boots{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
					}
				}
			}
		}
		{
			...
			if (!_ent.level.isClientSide() && _ent.getServer() != null) {
				...
				_ent.getServer().getCommands().performPrefixedCommand(_css,
						"give @s power:flash_light{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
			}
		}
		{
			Entity _ent = entity;
			if (!_ent.level.isClientSide() && _ent.getServer() != null) {
				...
				_ent.getServer().getCommands().performPrefixedCommand(_css,
						"give @s power:lighting{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
			}
		}
		{
			Entity _ent = entity;
			if (!_ent.level.isClientSide() && _ent.getServer() != null) {
				...
				_ent.getServer().getCommands().performPrefixedCommand(_css,
						"give @s power:light_sword{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
			}
		}
		{
			Entity _ent = entity;
