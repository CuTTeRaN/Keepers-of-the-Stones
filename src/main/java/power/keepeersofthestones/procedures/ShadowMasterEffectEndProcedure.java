	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
				...
				if (!(entity.getCapability(PowerModVariables.PLAYER_VARIABLES_CAPABILITY, null)
					...
					if ((entity.getCapability(PowerModVariables.PLAYER_VARIABLES_CAPABILITY, null)
						...
						if (entity instanceof LivingEntity _entity)
							_entity.addEffect(new MobEffectInstance(PowerModMobEffects.RECHARGE_SHADOW_STONE.get(), 3600, 0, (false), (false)));
					} else if ((entity.getCapability(PowerModVariables.PLAYER_VARIABLES_CAPABILITY, null)
							.orElse(new PowerModVariables.PlayerVariables())).power_level >= 3) {
						if (entity instanceof LivingEntity _entity)
							_entity.addEffect(new MobEffectInstance(PowerModMobEffects.RECHARGE_SHADOW_STONE.get(), 2400, 0, (false), (false)));
					} else {
						if (entity instanceof LivingEntity _entity)
		...
		}
		{
			...
			if (!_ent.level.isClientSide() && _ent.getServer() != null) {
				...
				_ent.getServer().getCommands().performPrefixedCommand(_css, "kill @e[type=power:shadow]");
			}
		}
	}
}
