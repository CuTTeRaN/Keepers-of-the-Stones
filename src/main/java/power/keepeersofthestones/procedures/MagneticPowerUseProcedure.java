...
public class MagneticPowerUseProcedure {
	public static void execute(LevelAccessor world, Entity entity, ItemStack itemstack) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == PowerModItems.MAGNETIC_FISHING_ROD
				.get()) {
				...
				_player.getCooldowns().addCooldown(itemstack.getItem(), 400);
			{
				...
				if (!_ent.level.isClientSide() && _ent.getServer() != null) {
					...
					_ent.getServer().getCommands().performPrefixedCommand(_css, "tp @e[type=minecraft:item] @p");
				}
			}
		}
	}
