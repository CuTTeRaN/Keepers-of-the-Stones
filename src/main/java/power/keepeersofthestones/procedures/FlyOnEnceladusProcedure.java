...
public class FlyOnEnceladusProcedure {
		...
		PowerMod.queueServerWork(200, () -> {
			PowerMod.queueServerWork(20, () -> {
				if (entity instanceof ServerPlayer _player && !_player.level.isClientSide()) {
					ResourceKey<Level> destinationType = ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("power:enceladus"));
