...
public class MagnetMasterEffectStartProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
					...
					.orElse(new PowerModVariables.PlayerVariables())).golden_dust) {
				{
					...
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						...
						_ent.getServer().getCommands().performPrefixedCommand(_css,
								"item replace entity @s armor.head with power:magnet_helmet{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
					}
				}
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						...
						_ent.getServer().getCommands().performPrefixedCommand(_css,
								"item replace entity @s armor.chest with power:magnet_chestplate{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
					}
				}
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						...
						_ent.getServer().getCommands().performPrefixedCommand(_css,
								"item replace entity @s armor.legs with power:magnet_leggings{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
					}
				}
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						...
						_ent.getServer().getCommands().performPrefixedCommand(_css,
								"item replace entity @s armor.feet with power:magnet_boots{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
					}
				}
			}
		}
		{
			...
			if (!_ent.level.isClientSide() && _ent.getServer() != null) {
				...
				_ent.getServer().getCommands().performPrefixedCommand(_css,
						"give @s power:magnetic_claws{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
			}
		}
		{
			Entity _ent = entity;
			if (!_ent.level.isClientSide() && _ent.getServer() != null) {
				...
				_ent.getServer().getCommands().performPrefixedCommand(_css,
						"give @s power:magnetic_fishing_rod{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
			}
		}
		{
			Entity _ent = entity;
			if (!_ent.level.isClientSide() && _ent.getServer() != null) {
				...
				_ent.getServer().getCommands().performPrefixedCommand(_css,
						"give @s power:electromagnetic_pulse{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
			}
		}
	}
}
