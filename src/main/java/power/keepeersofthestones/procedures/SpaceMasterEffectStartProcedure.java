...
public class SpaceMasterEffectStartProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		}
		{
			...
			if (!_ent.level.isClientSide() && _ent.getServer() != null) {
				...
				_ent.getServer().getCommands().performPrefixedCommand(_css,
						"give @s power:galactic_sword{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
			}
		}
		{
			Entity _ent = entity;
			if (!_ent.level.isClientSide() && _ent.getServer() != null) {
				...
				_ent.getServer().getCommands().performPrefixedCommand(_css,
						"give @s power:black_hole{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
			}
		}
		{
			Entity _ent = entity;
			if (!_ent.level.isClientSide() && _ent.getServer() != null) {
				...
				_ent.getServer().getCommands().performPrefixedCommand(_css,
						"give @s power:space_atlas{Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}");
			}
		}
	}
}
