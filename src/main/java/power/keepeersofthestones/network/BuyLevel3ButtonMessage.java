...
public class BuyLevel3ButtonMessage {
	...
	public BuyLevel3ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(BuyLevel3ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(BuyLevel3ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
